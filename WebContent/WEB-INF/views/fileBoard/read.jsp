...
<body>
	...
	${boardDto.boardNumber}, ${boardDto.groupNumber}, ${boardDto.sequenceNumber}, ${boardDto.sequenceLevel}
		...
		<c:if test="${boardDto.fileSize != 0 }">
			<div>
				<label class="six">파일명</label>
				<p><a href="${root}/fileBoard/downLoad.do?boardNumber=${boardDto.boardNumber}">${boardDto.fileName}</a></p>
			</div>
		</c:if>
		...
		<div class="bottom">
			...
			<input type="button" value="글목록" onclick="location.href='${root}/fileBoard/list.do'"/>
		</div>
	</div>
</body>
</html>